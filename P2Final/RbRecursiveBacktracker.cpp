...
bool RbRecursiveBacktracker::generate()
{
	bool res = true;
...
*/
bool RbRecursiveBacktracker::setup()
{
	bool res = true;
...
RbRecursiveBacktracker::RbRecursiveBacktracker(Maze& maze, int startEdge, int endEdge, float bias, 
	bool invertBias, float invertBiasChance, float chanceToIncrementAreaCode, bool prefersLoops)
{
...
RbRecursiveBacktracker::~RbRecursiveBacktracker()
{
	this->maze = nullptr;
}

unsigned long long int RbRecursiveBacktracker::randomInt(unsigned long long int min, unsigned long long int max)
{
...
float RbRecursiveBacktracker::randomFloat() {
	std::random_device rd;
	std::mt19937 gen(rd());
...
bool RbRecursiveBacktracker::carveNorth(unsigned long long cellX, unsigned long long cellY) {
...
bool RbRecursiveBacktracker::carveEast(unsigned long long cellX, unsigned long long cellY) {
...
bool RbRecursiveBacktracker::carveSouth(unsigned long long cellX, unsigned long long cellY) {
	this->maze->mazePtr[this->maze->getCellIndex(cellX, (cellY + 1))].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY + 1)));
	this->maze->mazePtr[this->maze->getCellIndex(cellX, (cellY + 2))].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY + 2)));
...
bool RbRecursiveBacktracker::carveWest(unsigned long long cellX, unsigned long long cellY) {
	this->maze->mazePtr[this->maze->getCellIndex((cellX - 1), cellY)].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX - 1), cellY));
	this->maze->mazePtr[this->maze->getCellIndex((cellX - 2), cellY)].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX - 2), cellY));
...
bool RbRecursiveBacktracker::writeAreaCodeToCell(unsigned long long int idx)
{
	bool res = false;
...
bool RbRecursiveBacktracker::carveSomeLoops()
{
