...
bool RbWvRecursiveBacktracker::generate()
{
	bool res = true;
	...
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, cellY));
	while (this->stack.size() > 0) {
		...
		*/
		...
		if (this->randomFloat() < this->chanceToIncrementAreaCode) {
			this->areaCode++;
			this->areaCodes.push_back(this->areaCode);
		}
	}
	if (prefersLoops) {
		this->carveSomeLoops();
...
*/
bool RbWvRecursiveBacktracker::setup()
{
	bool res = true;
...
RbWvRecursiveBacktracker::RbWvRecursiveBacktracker(Maze& maze, int startEdge, int endEdge, float bias, bool invertBias, 
													float invertBiasChance, float chanceToIncrementAreaCode, bool prefersLoops)
{
	...
	if (chanceToIncrementAreaCode <= 0 || chanceToIncrementAreaCode >= 1)
		chanceToIncrementAreaCode = .005f;
	this->maze = &maze;
	this->bias = bias;
	this->startEdge = startEdge;
	this->endEdge = endEdge;
	this->invertBiasChance = invertBiasChance;
	this->chanceToIncrementAreaCode = chanceToIncrementAreaCode;
	this->prefersLoops = prefersLoops;
	setup();
	generate();
}

RbWvRecursiveBacktracker::~RbWvRecursiveBacktracker()
{
	this->maze = nullptr;
}

unsigned long long int RbWvRecursiveBacktracker::randomInt(unsigned long long int min, unsigned long long int max)
{
...
float RbWvRecursiveBacktracker::randomFloat() {
	std::random_device rd;
	std::mt19937 gen(rd());
...
bool RbWvRecursiveBacktracker::canWeaveNorth(unsigned long long int cellX, unsigned long long int cellY)
{
	bool res = false;
...
bool RbWvRecursiveBacktracker::canWeaveEast(unsigned long long int cellX, unsigned long long int cellY)
{
	bool res = false;
	bool corridorGood = false;
	bool canonicalGood = false;
...
bool RbWvRecursiveBacktracker::canWeaveSouth(unsigned long long int cellX, unsigned long long int cellY)
{
	bool res = false;
	bool corridorGood = false;
	bool canonicalGood = false;
...
bool RbWvRecursiveBacktracker::canWeaveWest(unsigned long long int cellX, unsigned long long int cellY)
{
	bool res = false;
	bool corridorGood = false;
	bool canonicalGood = false;
...
bool RbWvRecursiveBacktracker::weaveNorth(unsigned long long int cellX, unsigned long long int cellY)
{
	...
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY - 1)));
	...
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY - 3)));
	this->maze->mazePtr[this->maze->getCellIndex(cellX, (cellY - 4))].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY - 4)));
	this->stack.push_back(this->maze->getCellIndex(cellX, (cellY - 4)));
	return true;
}

bool RbWvRecursiveBacktracker::weaveEast(unsigned long long int cellX, unsigned long long int cellY)
{
	...
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX + 1), cellY));
	...
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX + 3), cellY));
	this->maze->mazePtr[this->maze->getCellIndex((cellX + 4), cellY)].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX + 4), cellY));
	this->stack.push_back(this->maze->getCellIndex((cellX + 4), cellY));
	return true;
}

bool RbWvRecursiveBacktracker::weaveSouth(unsigned long long int cellX, unsigned long long int cellY)
{
	this->maze->mazePtr[this->maze->getCellIndex(cellX, (cellY + 1))].setCarved();
...
bool RbWvRecursiveBacktracker::weaveWest(unsigned long long int cellX, unsigned long long int cellY)
{
	this->maze->mazePtr[this->maze->getCellIndex((cellX - 1), cellY)].setCarved();
...
bool RbWvRecursiveBacktracker::carveNorth(unsigned long long cellX, unsigned long long cellY) {
	this->maze->mazePtr[this->maze->getCellIndex(cellX, (cellY - 1))].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY - 1)));
	this->maze->mazePtr[this->maze->getCellIndex(cellX, (cellY - 2))].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY - 2)));
	this->stack.push_back(this->maze->getCellIndex(cellX, (cellY - 2)));
	return true;
}

bool RbWvRecursiveBacktracker::carveEast(unsigned long long cellX, unsigned long long cellY) {
	this->maze->mazePtr[this->maze->getCellIndex((cellX + 1), cellY)].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX + 1), cellY));
	this->maze->mazePtr[this->maze->getCellIndex((cellX + 2), cellY)].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX + 2), cellY));
	this->stack.push_back(this->maze->getCellIndex((cellX + 2), cellY));
	return true;
}

bool RbWvRecursiveBacktracker::carveSouth(unsigned long long cellX, unsigned long long cellY) {
	this->maze->mazePtr[this->maze->getCellIndex(cellX, (cellY + 1))].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY + 1)));
	this->maze->mazePtr[this->maze->getCellIndex(cellX, (cellY + 2))].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex(cellX, (cellY + 2)));
...
bool RbWvRecursiveBacktracker::carveWest(unsigned long long cellX, unsigned long long cellY) {
	this->maze->mazePtr[this->maze->getCellIndex((cellX - 1), cellY)].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX - 1), cellY));
	this->maze->mazePtr[this->maze->getCellIndex((cellX - 2), cellY)].setCarved();
	this->writeAreaCodeToCell(this->maze->getCellIndex((cellX - 2), cellY));
...
bool RbWvRecursiveBacktracker::writeAreaCodeToCell(unsigned long long int idx)
{
	bool res = false;
	unsigned long long shiftedAreaCode = this->areaCode << 20;
	if (this->maze->mazePtr[idx].safeCustomSet(shiftedAreaCode))
		res = true;
	return res;
}

bool RbWvRecursiveBacktracker::carveSomeLoops()
{
